...
for obj in "${obj_list[@]}"; do
    ...
    original_last_model_less=output/${output_dir}/${obj}/original_complete_loss_rb_less
    ...
    less_ckpt=${original_last_model_less}/chkpnt15000.pth
    ...
    python train.py -s ${nerf_synthetic_dir}/${obj} \
        ...
        --hg_opt_flag \
        --random_background \
        --densify_grad_threshold 0.000245
